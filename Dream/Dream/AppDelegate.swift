...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // AppDelegate.swiftなどで、アプリ起動時に処理を行う
        
        // 色
        let redColor = UIColor(red: 236.0/255.0, green: 111.0/255.0, blue: 124.0/255.0, alpha:0.5)
        ...
        // ② ナビゲーションバーのタイトルの色
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.foregroundColor: whiteColor]
